...
class TestSnake:
    ...
    def test_snake_moves_up_correctly(self):
        ...
        snake.set_moving_direction('up')
        snake.move()
        assert snake.head.centery == 99 and snake.head.centerx == 100
    ...
    def test_snake_moves_down_correctly(self):
        ...
        snake.move()
        assert snake.head.centery == 101 and snake.head.centerx == 100
    ...
    def test_snake_moves_left_correctly(self):
        ...
        snake.set_moving_direction('left')
        snake.move()
        assert snake.head.centery == 100 and snake.head.centerx == 99
    ...
    def test_snake_moves_right_correctly(self):
        ...
        snake.move()
        assert snake.head.centery == 100 and snake.head.centerx == 101
